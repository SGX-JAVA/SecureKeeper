...
public class benchmarkTest {
	...
	public benchmarkTest(int threads, String hp, int ops) {
    ...
    public static void main(String[] args) {
        if (args.length < 3) {
            System.out.println("Usage: java -cp $CLASSPATH benchmarkTest #threads hostPort #ops");
            System.exit(1);
        }
        new benchmarkTest(Integer.parseInt(args[0]), args[1], Integer.parseInt(args[2])).go();
    }
    public void go() {
    	try {
